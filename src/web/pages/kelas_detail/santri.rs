...
pub(super) fn SantriTab(
    ...
    // KelasDetail::can_manage_jadwal (wali kelas ini + admin/ketua).
    ...
    view! {
        <div class="space-y-3 stagger">
            ...
            <AdminOnly can_manage=can_manage apa="menambah atau mengeluarkan santri dari kelas" siapa="admin, ketua, atau wali kelas ini">
                        ...
                        view! {
                            <div class="ppm-card p-3 flex items-start gap-3 card-hover anim-in ppm-accent">
                                ...
                                <div class="flex items-center gap-1.5 shrink-0">
                                    ...
                                    // atau wali kelas ini; tombolnya tak
